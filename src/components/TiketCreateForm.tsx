...
import { createTicket } from "../services/TiketAPI"; // Adjust path, only import createTicket
import { Tiket, TiketInput } from "../types/Tiket"; // Adjust path
...
interface TiketFormInputs extends Omit<TiketInput, "tanggal"> {
...
function TiketCreateForm() {
  ...
  const createMutation = useMutation<Tiket, Error, TiketInput>({
    mutationFn: (newTicketData) => {
      ...
      return createTicket(newTicketData);
    },
    onSuccess: (newTicket) => {
  ...
  return (
    <div className="tiket-app-container">
      {" "}
      {/* Keep container or adjust as needed */}
            ...
            <div className="form-group">
              ...
              <input
                ...
                {...register("stok", {
                  ...
                  validate: (value) =>
                    Number.isInteger(value) || "Stock must be a whole number", // Ensure integer
